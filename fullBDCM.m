...
elseif bDEBUG == 0    
    ...
    fitResults.startTimesSorted_B = startTimesSorted_B; fitResults.stimValuesSorted_A = stimValuesSorted_A;
    fitResults.stimValuesSorted_B = stimValuesSorted_B; fitResults.lengthHRF = lengthHRF; 
    fitResults.hrf = hrf; fitResults.SEHRF = SEHRF; fitResults.hrfPointsToSample = hrfPointsToSample; 
