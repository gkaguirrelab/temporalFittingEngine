...
%
% Compute method for the DElay and DUration model.
%
% Operates by calling forwardModelDEDU and then the applyKernel tfe method.
%
...
modelResponseStruct = forwardModelDEDU(params,stimulusStruct);
