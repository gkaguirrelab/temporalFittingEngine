...
%  This script take the volume or surface data in V1, and derives the 
%  HRF for each average slice time. Then a ouputs a mean HRF.
%
%  Written by Jovan Ortiz Bernhardt - Jul 2016
...
% Derive the HRF in avg V1 slices
