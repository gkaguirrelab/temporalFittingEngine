...
vScriptsList = {...
        ...
        {fullfile(rootDir, 'scripts', 'Models', 'DEDU')} ... 
        {fullfile(rootDir, 'scripts', 'Models', 'IAMP')} ... 
        {fullfile(rootDir, 'scripts', 'Models', 'TPUP')} ... 
        {fullfile(rootDir, 'scripts', 'Models', 'BTRM')} ... 
        {fullfile(rootDir, 'scripts', 'Library', 'CrossValidationRoutines')} ... 
    };
end